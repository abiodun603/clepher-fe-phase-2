...
const CaptureTools = () => {
  return (
    <>
      <Tabs defaultValue="post" className="pt-6 w-full px-4 md:px-0">   
        <div className="w-full md:grid md:grid-cols-5 gap-x-14 h-[70vh]">
          <div className='w-72'>
          ...
          <div className='md:col-span-4'>
            ...
            <TabsContent value="post" className='overflow-x-scroll'>  
              <PostManagement />                
            </TabsContent>
